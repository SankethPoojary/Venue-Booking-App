...
public class viewAllVenues extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_view_all_venues);
        ...
        calendarView.state().edit()
                .setMinimumDate(today)  // set minimum date
                .commit();
        ...
        bookedDetailsDBHandler check_db=new bookedDetailsDBHandler(this);
        Cursor check_cur=null;

        Cursor cursor=db.showAllVenues();
        ...
        if(cursor_count>0)
        {
            ...
            do
            {
                ...
                @SuppressLint("Range") String venueType = cursor.getString(cursor.getColumnIndex("type"));
                ...
                t9.setLayoutParams(txtParam);
                t9.setPadding(20,0,0,0);
                t9.setTextColor(this.getColor(R.color.Blue2));
                t9.setText(venueType);
                t9.setTextSize(16);
//                t9.setGravity(Gravity.RIGHT);
                ...
                if(check_cur.getCount()>0)
                {
                    ...
                    t3.setTextColor(this.getColor(R.color.red));
                    onClick_flag=true;
                }
                else
                {
                    t3.setText(venueStatus);
                    t3.setTextColor(this.getColor(R.color.green));
                    onClick_flag=false;
                }
                ...
                // ratings icon's params ( Mostly edit icon's) ( Definetly not rating icon's)
                LinearLayout.LayoutParams imgParams2 = (new LinearLayout.LayoutParams(50, 50));

                //edit button
                ImageView editBtn = new ImageView(this);
                LinearLayout.LayoutParams btnParams = (new LinearLayout.LayoutParams(55,55));
                btnParams.setMargins(0, -80, 50, 30);
                btnParams.gravity = Gravity.RIGHT;
                editBtn.setImageResource(R.drawable.edit3);
                editBtn.setLayoutParams(btnParams);
                if(!onClick_flag)
                {
                    // allow edit only if venue is available
                    subMain.addView(editBtn);
                    // adjust ratings margin
                    imgParams2.setMargins(0, 0, 20, 20);
                }
                else
                {
                    // adjust ratings margin
...
//                subMain.addView(t4);
                ...
                editBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view)
                    {
                            Intent editPage=new Intent(viewAllVenues.this, editVenue.class);
                            editPage.putExtra("Venue_Name",venueName);
        ...
        {
            Toast.makeText(viewAllVenues.this,"No venues to display!!!",Toast.LENGTH_LONG).show();
        }
        ...
        closeCalenderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // calendar texts
                red_text.setText(viewAllVenues.this.getString(R.string.red_txt1));
    ...
    {
        bookedDetailsDBHandler db = new bookedDetailsDBHandler(viewAllVenues.this);
...
//                    button.setTextColor(getResources().getColor(R.color.white));
    ...
    public void markDatesFun(String v_venueName) {
        ...
        dateDecorator = new dateDecorator(viewAllVenues.this, datesToMark);
...
//                            String dt = year + "-" + month + "-" + day;
        ...
        dateDecorator2 = new dateDecorator2(viewAllVenues.this, datesToMark);
